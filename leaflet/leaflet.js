...
(function(t, e, i) {
    var n = t.L
      , o = {};
    o.version = "0.6-dev",
    "object" == typeof module && "object" == typeof module.exports ? module.exports = o : "function" == typeof define && define.amd && define("leaflet", [], function() {
        return o
    }),
    ...
    function() {
        ...
        var s = 0
          , a = t.requestAnimationFrame || e("RequestAnimationFrame") || n
          , r = t.cancelAnimationFrame || e("CancelAnimationFrame") || e("CancelRequestAnimationFrame") || function(e) {
            t.clearTimeout(e)
        }
        ;
        o.Util.requestAnimFrame = function(e, s, r, h) {
            return e = o.bind(e, s),
            r && a === n ? (e(),
            i) : a.call(t, e, h)
        }
    ...
    o.Mixin.Events = {
        addEventListener: function(t, e, i) {
            if (o.Util.invokeEach(t, this.addEventListener, this, e, i))
                return this;
            var n, a, r, h, l, u, c, d = this[s] = this[s] || {}, _ = i && o.stamp(i);
        ...
        removeEventListener: function(t, e, i) {
            ...
            if (o.Util.invokeEach(t, this.removeEventListener, this, e, i))
                return this;
            var n, a, r, h, l, u, c, d, _ = this[s], p = i && o.stamp(i);
            for (t = o.Util.splitWords(t),
            n = 0,
            a = t.length; a > n; n++)
                if (r = t[n],
                ...
                e) {
                    if (h = i && d ? d[p] : _[r]) {
                        for (l = h.length - 1; l >= 0; l--)
                            h[l].action !== e || i && h[l].context !== i || h.splice(l, 1);
                        i && d && 0 === h.length && (delete d[p],
                        _[c]--)
                    }
                } else
                    delete _[r],
    ...
    o.DomUtil = {
        ...
        disableTextSelection: function() {
            ...
            this._onselectstart || (this._onselectstart = e.onselectstart || null,
            e.onselectstart = o.Util.falseFn)
        },
        enableTextSelection: function() {
            e.onselectstart === o.Util.falseFn && (e.onselectstart = this._onselectstart,
    ...
    o.LatLngBounds.prototype = {
        extend: function(t) {
            return t = "number" == typeof t[0] || "string" == typeof t[0] || t instanceof o.LatLng ? o.latLng(t) : o.latLngBounds(t),
    ...
    o.Map = o.Class.extend({
        ...
        initialize: function(t, e) {
            ...
            e.center && e.zoom !== i && this.setView(o.latLng(e.center), e.zoom, !0),
        ...
        setZoomAround: function(t, e) {
            var i = this.getZoomScale(e)
              ...
              , a = s.subtract(n).multiplyBy(1 - 1 / i)
              , r = this.containerPointToLatLng(n.add(a));
        ...
        setMaxBounds: function(t) {
            ...
            return this._boundsMinZoom = e,
            this._loaded && (e > this._zoom ? this.setView(t.getCenter(), e) : this.panInsideBounds(t)),
        ...
        invalidateSize: function(t) {
            ...
            return (0 !== n.x || 0 !== n.y) && (t === !0 ? this.panBy(n) : (this._rawPanBy(n),
            this.fire("move"),
        ...
        _initLayout: function() {
            ...
            o.Browser.touch && o.DomUtil.addClass(t, "leaflet-touch"),
            this.options.fadeAnimation && o.DomUtil.addClass(t, "leaflet-fade-anim");
    ...
    o.Projection.Mercator = {
        ...
        project: function(t) {
            ...
            return h = -a * Math.log(d),
            new o.Point(r,h)
        },
        unproject: function(t) {
            for (var e, i = o.LatLng.RAD_TO_DEG, n = this.R_MAJOR, s = this.R_MINOR, a = t.x * i / n, r = s / n, h = Math.sqrt(1 - r * r), l = Math.exp(-t.y / s), u = Math.PI / 2 - 2 * Math.atan(l), c = 15, d = 1e-7, _ = c, p = .1; Math.abs(p) > d && --_ > 0; )
                e = h * Math.sin(u),
                p = Math.PI / 2 - 2 * Math.atan(l * Math.pow((1 - e) / (1 + e), .5 * h)) - u,
                u += p;
    ...
    o.TileLayer = o.Class.extend({
        ...
        onAdd: function(t) {
            this._map = t,
            this._animated = t.options.zoomAnimation && o.Browser.any3d,
            this._initContainer(),
        ...
        _tileShouldBeLoaded: function(t) {
            ...
            if (this.options.bounds) {
                ...
                if (!this.options.bounds.intersects([s, a]))
                    return !1
            }
            return !0
        },
    ...
    o.TileLayer.WMS = o.TileLayer.extend({
        ...
        initialize: function(t, e) {
            ...
            for (var s in e)
                this.options.hasOwnProperty(s) || (i[s] = e[s]);
            this.wmsParams = i,
            o.setOptions(this, e)
        },
        onAdd: function(t) {
    ...
    o.Icon = o.Class.extend({
        ...
        _createImg: function(t) {
            var i;
            return o.Browser.ie6 ? (i = e.createElement("div"),
            i.style.filter = 'progid:DXImageTransform.Microsoft.AlphaImageLoader(src="' + t + '")') : (i = e.createElement("img"),
            i.src = t),
            i
        },
    ...
    o.Marker = o.Class.extend({
        ...
        _initIcon: function() {
            ...
            o.DomUtil.addClass(this._icon, n),
            t.riseOnHover && o.DomEvent.on(this._icon, "mouseover", this._bringToFront, this).on(this._icon, "mouseout", this._resetZIndex, this)),
            this._shadow || (this._shadow = t.icon.createShadow(),
            this._shadow && (o.DomUtil.addClass(this._shadow, n),
            s = 1 > this.options.opacity)),
        ...
        _fireMouseEvent: function(t) {
            ...
            "mousedown" !== t.type && o.DomEvent.stopPropagation(t)
        },
        setOpacity: function(t) {
    ...
    o.DivIcon = o.Icon.extend({
        ...
        createIcon: function() {
            var t = e.createElement("div")
              , i = this.options;
            return i.html && (t.innerHTML = i.html),
            i.bgPos && (t.style.backgroundPosition = -i.bgPos.x + "px " + -i.bgPos.y + "px"),
    ...
    o.Map.include({
        openPopup: function(t, e, i) {
            ...
            return this._popup = t,
            this.addLayer(t)
        },
        closePopup: function() {
            return this._popup && (this.removeLayer(this._popup),
            this._popup = null),
            this
        }
    }),
    ...
    o.LayerGroup = o.Class.extend({
        ...
        removeLayer: function(t) {
            var e = this.getLayerId(t);
            return this._map && this._layers[e] && this._map.removeLayer(t),
            delete this._layers[e],
            this
        },
        hasLayer: function(t) {
    ...
    o.FeatureGroup = o.LayerGroup.extend({
        ...
        removeLayer: function(t) {
            return t.off(o.FeatureGroup.EVENTS, this._propagateEvent, this),
    ...
    o.Path = o.Path.SVG && !t.L_PREFER_CANVAS || !o.Browser.canvas ? o.Path : o.Path.extend({
        ...
        _onMouseMove: function(t) {
            this._map._animatingZoom || (this._containsPoint(t.layerPoint) ? (this._ctx.canvas.style.cursor = "pointer",
            this._mouseInside = !0,
    ...
    o.LineUtil = {
        ...
        _getEdgeIntersection: function(t, e, n, s) {
            var a = e.x - t.x
              , r = e.y - t.y
              , h = s.min
              , l = s.max;
            return 8 & n ? new o.Point(t.x + a * (l.y - t.y) / r,l.y) : 4 & n ? new o.Point(t.x + a * (h.y - t.y) / r,h.y) : 2 & n ? new o.Point(l.x,t.y + r * (l.x - t.x) / a) : 1 & n ? new o.Point(h.x,t.y + r * (h.x - t.x) / a) : i
        },
    ...
    o.Polyline = o.Path.extend({
        ...
        _clipPoints: function() {
            var t, e, n, s = this._originalPoints, a = s.length;
            if (this.options.noClip)
                return this._parts = [s],
                i;
            this._parts = [];
            var r = this._parts
            ...
            for (t = 0,
            e = 0; a - 1 > t; t++)
                n = l.clipSegment(s[t], s[t + 1], h, t),
                n && (r[e] = r[e] || [],
                r[e].push(n[0]),
                (n[1] !== s[t + 1] || t === a - 2) && (r[e].push(n[1]),
                e++))
        },
    ...
    o.PolyUtil.clipPolygon = function(t, e) {
        var i, n, s, a, r, h, l, u, c, d = [1, 4, 2, 8], _ = o.LineUtil;
        for (n = 0,
        l = t.length; l > n; n++)
            t[n]._code = _._getBitCode(t[n], e);
        for (a = 0; 4 > a; a++) {
            for (u = d[a],
            i = [],
            n = 0,
            ...
            s = l - 1; l > n; s = n++)
                r = t[n],
                h = t[s],
                r._code & u ? h._code & u || (c = _._getEdgeIntersection(h, r, u, e),
                c._code = _._getBitCode(c, e),
                i.push(c)) : (h._code & u && (c = _._getEdgeIntersection(h, r, u, e),
                c._code = _._getBitCode(c, e),
                i.push(c)),
                i.push(r));
            t = i
    ...
    o.GeoJSON = o.FeatureGroup.extend({
        ...
        addData: function(t) {
            ...
            if (n) {
                for (e = 0,
                i = n.length; i > e; e++)
                    (n[e].geometries || n[e].geometry || n[e].features) && this.addData(n[e]);
                return this
            }
            var s = this.options;
    ...
    ,
    o.DomEvent = {
        addListener: function(t, e, n, s) {
            var a, r, h, l = o.stamp(n), u = "_leaflet_" + e + l;
            return t[u] ? this : (a = function(e) {
                return n.call(s || t, e || o.DomEvent._getEvent())
            }
            ,
            o.Browser.msTouch && 0 === e.indexOf("touch") ? this.addMsTouchListener(t, e, a, l) : (o.Browser.touch && "dblclick" === e && this.addDoubleTapListener && this.addDoubleTapListener(t, a, l),
            "addEventListener"in t ? "mousewheel" === e ? (t.addEventListener("DOMMouseScroll", a, !1),
            t.addEventListener(e, a, !1)) : "mouseenter" === e || "mouseleave" === e ? (r = a,
            h = "mouseenter" === e ? "mouseover" : "mouseout",
            a = function(e) {
                return o.DomEvent._checkMouse(t, e) ? r(e) : i
            }
            ,
            t.addEventListener(h, a, !1)) : "click" === e && o.Browser.android ? (r = a,
            a = function(t) {
                return o.DomEvent._filterClick(t, r)
            }
            ,
        ...
        _filterClick: function(t, e) {
            var n = t.timeStamp || t.originalEvent.timeStamp
              , s = o.DomEvent._lastClick && n - o.DomEvent._lastClick;
            return s && s > 100 && 400 > s ? (o.DomEvent.stop(t),
            i) : (o.DomEvent._lastClick = n,
            e(t))
        }
    },
    ...
    o.Draggable = o.Class.extend({
        ...
        initialize: function(t, e, i) {
            ...
            this._longPress = i && !o.Browser.msTouch
        },
        enable: function() {
            if (!this._enabled) {
        ...
        _onDown: function(t) {
            if (!t.shiftKey && (1 === t.which || 1 === t.button || t.touches) && (o.DomEvent.preventDefault(t).stopPropagation(t),
            !o.Draggable._disabled)) {
                this._simulateClick = !0;
                var n = t.touches && t.touches.length || 0;
                if (n > 1)
                    return this._simulateClick = !1,
                    clearTimeout(this._longPressTimeout),
                    i;
                var s = 1 === n ? t.touches[0] : t
                  , a = s.target;
                o.Browser.touch && "a" === a.tagName.toLowerCase() && o.DomUtil.addClass(a, "leaflet-active"),
                this._moved = !1,
                this._moving || (this._startPoint = new o.Point(s.clientX,s.clientY),
                this._startPos = this._newPos = o.DomUtil.getPosition(this._element),
                1 === n && o.Browser.touch && this._longPress && (this._longPressTimeout = setTimeout(o.bind(function() {
                    var t = this._newPos && this._newPos.distanceTo(this._startPos) || 0;
                    o.Draggable.TAP_TOLERANCE > t && (this._simulateClick = !1,
                    this._onUp(),
        ...
        _onMove: function(t) {
            if (!(t.touches && t.touches.length > 1)) {
                ...
                o.Browser.touch || (o.DomUtil.disableTextSelection(),
        ...
        _onUp: function(t) {
            var i, n, s, a, r;
            clearTimeout(this._longPressTimeout),
            this._simulateClick && t.changedTouches && (s = this._newPos && this._newPos.distanceTo(this._startPos) || 0,
            i = t.changedTouches[0],
            n = i.target,
            "a" === n.tagName.toLowerCase() && o.DomUtil.removeClass(n, "leaflet-active"),
            o.Draggable.TAP_TOLERANCE > s && (a = !0)),
            o.Browser.touch || (o.DomUtil.enableTextSelection(),
            o.DomUtil.removeClass(e.body, "leaflet-dragging"));
            for (r in o.Draggable.MOVE)
                o.DomEvent.off(e, o.Draggable.MOVE[r], this._onMove).off(e, o.Draggable.END[r], this._onUp);
    ...
    o.Map.Drag = o.Handler.extend({
        addHooks: function() {
            if (!this._draggable) {
                var t = this._map;
                this._draggable = new o.Draggable(t._mapPane,t._container,t.options.longPress),
                this._draggable.on({
        ...
        _onDragEnd: function() {
            ...
            n)
                ...
                _.x && _.y ? o.Util.requestAnimFrame(function() {
                    t.panBy(_, d, r, !0)
                }) : t.fire("moveend")
            }
        }
    ...
    o.extend(o.DomEvent, {
        ...
        addDoubleTapListener: function(t, i, n) {
            function s(t) {
                var e;
                if (o.Browser.msTouch ? (p.push(t.pointerId),
                e = p.length) : e = t.touches.length,
                !(e > 1)) {
                    var i = Date.now()
                      , n = i - (r || i);
            ...
            var r, h, l = !1, u = 250, c = "_leaflet_", d = this._touchstart, _ = this._touchend, p = [];
            t[c + d + n] = s,
            t[c + _ + n] = a;
            var m = o.Browser.msTouch ? e.documentElement : t;
            return t.addEventListener(d, s, !1),
            m.addEventListener(_, a, !1),
    ...
    o.Map.TouchZoom = o.Handler.extend({
        ...
        _onTouchEnd: function() {
            ...
            var n = this._getScaleOrigin()
              , s = t.layerPointToLatLng(n)
              , a = t.getZoom()
              , r = t.getScaleZoom(this._scale) - a
              , h = r > 0 ? Math.ceil(r) : Math.floor(r)
              , l = t._limitZoom(a + h)
              , u = t.getZoomScale(l) / this._scale;
            t._animateZoom(s, l, n, u, null, !0)
        },
    ...
    o.Map.BoxZoom = o.Handler.extend({
        ...
        _onMouseDown: function(t) {
            ...
            o.DomEvent.on(e, "mousemove", this._onMouseMove, this).on(e, "mouseup", this._onMouseUp, this).on(e, "keydown", this._onKeyDown, this).preventDefault(t),
    ...
    o.Handler.MarkerDrag = o.Handler.extend({
        ...
        removeHooks: function() {
            this._draggable.off("dragstart", this._onDragStart).off("drag", this._onDrag).off("dragend", this._onDragEnd),
            this._draggable.disable()
        },
        moved: function() {
            return this._draggable && this._draggable._moved
    ...
    o.Control.Layers = o.Control.extend({
        ...
        _initLayout: function() {
            ...
            if (this.options.collapsed) {
                ...
                n.href = "#",
                n.title = "Layers",
                o.Browser.touch ? o.DomEvent.on(n, "click", o.DomEvent.stopPropagation).on(n, "click", o.DomEvent.preventDefault).on(n, "click", this._expand, this) : o.DomEvent.on(n, "focus", this._expand, this),
        ...
        _onInputClick: function() {
            ...
            t = 0; s > t; t++)
                ...
                e.checked && !this._map.hasLayer(i.layer) ? (this._map.addLayer(i.layer),
                i.overlay ? this._map.fire("overlayadd", {
                    layer: i
                }) : n = i.layer) : !e.checked && this._map.hasLayer(i.layer) && (this._map.removeLayer(i.layer),
                this._map.fire("overlayremove", {
                    layer: i
                }));
            n && (this._map.setZoom(this._map.getZoom()),
    ...
    o.PosAnimation = o.Class.extend({
        ...
        _getPos: function() {
            ...
            return o.Browser.any3d ? (n = a[o.DomUtil.TRANSFORM].match(this._transformRe),
            e = parseFloat(n[1]),
            i = parseFloat(n[2])) : (e = parseFloat(a.left),
            i = parseFloat(a.top)),
            new o.Point(e,i,!0)
        },
    ...
    o.Map.include({
        setView: function(t, e, i) {
            ...
            if (s) {
                var a = n ? this.options.zoomAnimation && this._animateZoomIfClose && this._animateZoomIfClose(t, e) : this._animatePanIfClose(t);
                if (a)
        ...
        panBy: function(t, e, i, n) {
            ...
            !t.x && !t.y)
                return this;
            this._panAnim || (this._panAnim = new o.PosAnimation,
            this._panAnim.on({
            ...
            return this._panAnim.run(this._mapPane, s, e || .25, i),
            this
        },
        ...
        _animatePanIfClose: function(t) {
            ...
            return this.getSize().contains(e) ? (this.panBy(e),
            !0) : !1
        }
    }),
    ...
    o.Map.include(o.DomUtil.TRANSITION ? {
        ...
        _animateZoomIfClose: function(t, e) {
            if (this._animatingZoom)
                return !0;
            if (Math.abs(e - this._zoom) > this.options.zoomAnimationThreshold)
                return !1;
            var i = this.getZoomScale(e)
              , n = this._getCenterOffset(t)._divideBy(1 - 1 / i)
              , o = this._getCenterLayerPoint()._add(n);
            return this.getSize().contains(n) ? (this.fire("movestart").fire("zoomstart"),
            this._animateZoom(t, e, o, i),
            !0) : !1
        },
    ...
    o.TileLayer.include({
        _animateZoom: function(t) {
            ...
            e = !0),
            e && this._prepareBgBuffer();
            var i = o.DomUtil.TRANSFORM
              , n = this._bgBuffer;
            e && (clearTimeout(this._clearBgBufferTimer),
            o.Util.falseFn(n.offsetWidth));
            var s = o.DomUtil.getScaleString(t.scale, t.origin)
              , a = n.style[i];
            n.style[i] = t.backwards ? (t.delta ? o.DomUtil.getTranslateString(t.delta) : a) + " " + s : s + " " + a
        },
        ...
        _prepareBgBuffer: function() {
            var t = this._tileContainer
              , e = this._bgBuffer;
            return e && this._getLoadedTilesPercentage(e) > .5 && .5 > this._getLoadedTilesPercentage(t) ? (t.style.visibility = "hidden",
